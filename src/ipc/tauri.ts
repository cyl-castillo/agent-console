...
export const ipc = {
  ...
  memoryFeedbackPin: (projectRoot: string, docId: string, pinned: boolean) =>
    invoke<DocFeedback>("memory_feedback_pin", { projectRoot, docId, pinned }),
  ...
  worktreeCreate: (name: string, base?: string, branch?: string) =>
    invoke<WorktreeCreated>("worktree_create", {
      name,
      base: base ?? null,
      branch: branch ?? null,
    }),
  ...
  worktreeSetupSet: (config: WorktreeSetupConfig) => invoke<void>("worktree_setup_set", { config }),
  ...
  testigoPublicKey: () => invoke<{ keyId: string; publicKey: string }>("testigo_public_key"),
  ...
  mcpRemove: (name: string, scope: string) => invoke<string>("mcp_remove", { name, scope }),
  ...
  advisorCreateSkill: (scope: "project" | "user", name: string, skillMdContent: string) =>
  ...
  learningApplyRefactor: (targetKind: "skill" | "memory", name: string, newContent: string) =>
  ...
  roundtableStart: (config: RoundtableConfig) => invoke<string>("roundtable_start", { config }),
  ...
  roundtableShare: (id: string) => invoke<ShareResult>("roundtable_share", { id }),
  ...
  importWorkApply: (projectRoot: string, srcPath: string, decisions: ImportDecisions) =>
