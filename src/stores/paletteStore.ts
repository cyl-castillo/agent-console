...
const ACTIONS: PaletteAction[] = [
  ...
  },
  {
    id: "nav.tasks",
    label: "Open Tasks",
    hint: "Workbench → Tasks (your assigned Jira issues)",
    keywords: ["jira", "issues", "tickets", "queue"],
  ...
  },
  {
    ...
    keywords: ["calendar", "due", "upcoming"],
    run: () => emit("ac:open-workbench-tab", "agenda"),
  },
  {
    id: "nav.notes",
    label: "Open Notes",
    hint: "Workbench → Notes (per-project scratchpad)",
    keywords: ["sticky", "scratchpad", "todo"],
    run: () => emit("ac:open-workbench-tab", "notes"),
  },
  {
    id: "nav.proof",
    label: "Open Proof",
    hint: "Workbench → Proof (evidence ledger, signed packets)",
    keywords: ["testigo", "evidence", "ledger", "packet", "audit", "witness"],
    run: () => emit("ac:open-workbench-tab", "proof"),
  },
  {
    id: "nav.learning",
    label: "Open Learning",
    hint: "Workbench → Learning (reflect on your activity)",
    keywords: ["reflect", "curator", "improve"],
    run: () => emit("ac:open-workbench-tab", "learning"),
  },
  {
    id: "nav.roundtable",
    label: "Open Room",
    hint: "Workbench → Room (you + N agents on one problem)",
    keywords: ["roundtable", "agents", "debate", "cowork"],
  ...
  },
  {
    ...
    keywords: ["scheduler", "jobs", "cron", "recurring"],
    run: () => emit("ac:open-workbench-tab", "schedule"),
  },
  {
    id: "nav.transfer",
    label: "Open Transfer",
