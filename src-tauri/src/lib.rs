...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // Failed tool runs (Claude only): the test suite that exited
            // non-zero is evidence too.
            if let Err(e) = state.hooks.ensure_posttoolusefailure_autoinstalled() {
                tracing::warn!("hooks: posttoolusefailure auto-install failed: {e}");
            }
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::terminal::term_agent_sessions,
            ...
            commands::inject::work_profile_set,
            commands::learning::learning_apply_profile,
            ...
            commands::teams::teams_status,
            commands::teams::teams_begin_login,
            commands::teams::teams_poll_login,
            commands::teams::teams_cancel_login,
            commands::teams::teams_disconnect,
            commands::teams::teams_list_chats,
            commands::teams::teams_list_messages,
