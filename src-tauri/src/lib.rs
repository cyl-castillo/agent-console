...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pairing::pairing_pending,
            commands::pairing::pairing_approve,
            commands::pairing::pairing_reject,
            commands::pairing::devices_list,
            commands::pairing::devices_revoke,
            commands::pairing::devices_set_scope,
            commands::pairing::pairing_simulate_incoming,
            commands::pairing::voice_server_start,
            commands::pairing::voice_server_stop,
            commands::pairing::voice_server_status,
